...
from backend.tests.ingestion.sec_dense_pipeline_html.integration.conftest import (
...
async def test_pre_run_returns_content_count_excluding_commit_marker(
    ...
    from backend.evals.eval_tasks import pre_run_sec_retrieval
    from backend.ingestion.sec_dense_pipeline_html.vectorizer import ingest_filing
...
async def test_pre_run_raises_when_only_commit_marker_present(clean_collection):
    ...
    from backend.evals.eval_tasks import pre_run_sec_retrieval
    from backend.ingestion.sec_dense_pipeline_html.collection_schema import (
        async_ensure_collection_and_indexes,
    )
    from backend.ingestion.sec_dense_pipeline_html.common import commit_marker_id
    from backend.ingestion.sec_dense_pipeline_html.vectorizer import _EMBED_DIM

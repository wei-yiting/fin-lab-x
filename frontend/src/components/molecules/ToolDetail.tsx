  ...
  return (
    <div data-testid="tool-detail" className="space-y-2 p-3 text-xs">
      <div>
        ...
        <pre data-testid="tool-input-json" className="overflow-auto rounded bg-muted/50 p-2 font-mono text-[var(--chat-fg-secondary)]">
      ...
      {output !== undefined && (
        <div>
          ...
          <pre data-testid="tool-output-json" className="overflow-auto rounded bg-muted/50 p-2 font-mono text-[var(--chat-fg-secondary)]">

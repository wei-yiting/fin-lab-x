...
const fixture: SSEStreamFixture = {
  description:
    "Inline markdown links with javascript:/mailto:/https: — security guard test for body links (no ref defs)",
  ...
  chunks: [
    ...
    { delayMs: 30, data: { type: "text-start", id: "t1" } },
    {
      ...
      data: {
        ...
        id: "t1",
        delta:
          "Visit [bad site](javascript:alert('xss')) and [mail link](mailto:x@y.com) and [safe](https://example.com).",
      },
    },

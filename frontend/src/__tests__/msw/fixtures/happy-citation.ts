...
const fixture: SSEStreamFixture = {
  ...
  chunks: [
    ...
    { data: { type: 'text-delta', id: 't1', delta: 'Analysis shows strong growth [1] in the technology sector. ' } },
    { data: { type: 'text-delta', id: 't1', delta: 'Bloomberg reports [2] confirm the trend.\n\n' } },
    { data: { type: 'text-delta', id: 't1', delta: '[1]: https://reuters.com/tech-report "Reuters Tech Report"\n' } },
    { data: { type: 'text-delta', id: 't1', delta: '[2]: https://bloomberg.com/analysis "Bloomberg Analysis"\n' } },

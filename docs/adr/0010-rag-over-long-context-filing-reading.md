...
CONTEXT.md) are served by chunk retrieval (`sec_filing_search`, ADR-0018), not by loading
...
3. **Chunk-level citations only exist on the retrieval path.** Per ADR-0019, the product's

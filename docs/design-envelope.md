...
| Concurrent JIT of same ticker | May happen | Acceptable: duplicate work resolved by idempotent upsert on deterministic IDs. No distributed locks, no job queues. |

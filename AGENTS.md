...
- Run the gate: `pytest backend/evals/regression/ -m eval` (red = a task crash, a gated scorer below its metric floor, a fully-empty gated metric, or an enabled scenario with zero gated scorers; see ADR-0008/ADR-0016)

 ...
 * streaming message's markdown. Coalescing updates to roughly 20Hz (about
 * 3 frames at a 60Hz display) keeps the text visibly flowing while cutting
 * the number of parses by roughly an order of magnitude.
 */

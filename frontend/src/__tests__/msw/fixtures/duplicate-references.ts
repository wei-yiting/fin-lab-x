...
const fixture: SSEStreamFixture = {
  ...
  chunks: [
    ...
    { delayMs: 80,  data: { type: 'text-delta', id: 't1', delta: 'Analysis shows strong results [1] in the sector.\n\n' } },
    { delayMs: 130, data: { type: 'text-delta', id: 't1', delta: '[1]: https://reuters.com/report-a "Reuters Report A"\n' } },
    { delayMs: 180, data: { type: 'text-delta', id: 't1', delta: '[1]: https://bloomberg.com/report-b "Bloomberg Report B"\n' } },

...
const fixture: SSEStreamFixture = {
  ...
  chunks: [
    ...
    { data: { type: 'tool-input-available', toolCallId: 'tc-quote', toolName: 'yfinance_quote', input: { ticker: 'AAPL' } } },
    { delayMs: 100, data: { type: 'tool-output-available', toolCallId: 'tc-quote', output: { price: 189.84 } } },

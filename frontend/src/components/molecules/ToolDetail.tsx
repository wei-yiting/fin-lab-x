    ...
    <div data-testid="tool-detail" className="space-y-2 p-3 text-xs">
      <div>
        ...
        <pre
          ...
          className="whitespace-pre-wrap break-all rounded bg-muted/50 p-2 font-mono text-[var(--chat-fg-secondary)]"
        >
      ...
      {errorDetail && (
        <div>
          ...
          <pre
            ...
            className="overflow-auto rounded bg-destructive/10 p-2 font-mono text-destructive"
          >
            {errorDetail}
          </pre>
        </div>
